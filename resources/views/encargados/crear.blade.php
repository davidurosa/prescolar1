...
@endif
  ...
  <div class="container-fluid">
   ...
   <div class="col-md-12">
       ...
       <div class="card ">
         <form class="form-horizontal" action="/estudiantes/crear/encargados" method="POST" enctype="multipart/form-data" >
     @csrf 
             ...
             <div class="card-header card-header-primary">
               ...
               <h3 class="card-title"> Registro</h3>
                 <h6 class="card-title"> Datos del encargado a Buscarlo </h6>
             ...
             <div class="card-body justify-content-center">
               ...
               <div class="row">
                   ...
                   <div class="col-md-3">
                     <div class="form-group has-default bmd-form-group">
                       <label class="bmd-label-floating"><i class="material-icons">person</i> parentesco</label><br>
                       <textarea type="text" class="form-control" value="{{ old('parentesco') }}" required pattern="[A-Za-z]{4,200}" title="SÓLO SE ADMITEN LETRAS. Tamaño mínimo: 4, Tamaño máximo: 20" name="parentesco" ></textarea>
                     </div> 
                   </div>                        
                   ...
                   <div class="col-md-3">
                    <div class="form-group has-default bmd-form-group">
                      ...
                      <textarea type="text" class="form-control" value="{{ old('direccion_encargado') }}" required pattern="[A-Za-z]{4,200}" title="SÓLO SE ADMITEN LETRAS. Tamaño mínimo: 4, Tamaño máximo: 20" name="direccion_encargado" ></textarea>
                    </div> 
                  </div>
