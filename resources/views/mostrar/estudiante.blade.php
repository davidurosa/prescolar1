          ...
          <div class="card " style="box-shadow : 5px 5px 25px  #cacaca;">
              ...
              <div class="card-body ">
                  <h4 class="card-title text-center">{{$estudiante->nombre_estudiante}} {{$estudiante->apellido_estudiante}}
                      ...
                      Seccion : <a class="text-info" href="seccion/{{$estudiante->id_maestro}}">{{$estudiante->seccion}}</a>  <br> 
                      Nivel : <a class="text-info" href="#"> {{$estudiante->nivel}} </a>
                      <br>

                    
         
      <a class="btn btn-success btn-just-icon btn-fill btn-round btn-wd" href="/estudiantes/{{$estudiante->id}}"><i class="material-icons">mode_edit</i></a>
