          ...
          <form method="post" action="{{ route('user.store') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header card-header-info">
                <h4 class="card-title">{{ __('agregar suario') }}</h4>
                <p class="card-category"></p>
              </div>
              <div class="card-body ">
                <div class="row">
                  <div class="col-md-12 text-right">
                      <a href="{{ route('user.index') }}" class="btn btn-sm btn-info">{{ __('Volver a la lista') }}</a>
                  </div>
                </div>
                <div class="row">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-info">{{ __('agragar usuario') }}</button>
              </div>
            </div>
          </form>
        </div>
