          ...
          <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                @endif
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-current-password">{{ __('Contraseña') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('old_password') ? ' is-invalid' : '' }}" input type="password" name="old_password" id="input-current-password" placeholder="{{ __('contraseña...') }}" value="" required />
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-password-confirmation">{{ __(' nueva contraseña') }}</label>
                  <div class="col-sm-7">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-info">{{ __('Cambiar la contraseña') }}</button>
              </div>
            </div>
          </form>
        </div>
