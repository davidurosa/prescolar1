...
@endif
     ...
     <div class="container-fluid">
      ...
      <div class="col-md-12">
          ...
          <div class="card ">
            <form class="form-horizontal" action="/estudiantes/crear/mama" method="POST" enctype="multipart/form-data" >
        @csrf 
                ...
                <div class="card-body justify-content-center">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group has-default bmd-form-group">
                          <label class="bmd-label-floating"><i class="material-icons">work</i> Trabajo</label><br>
                          <textarea type="text" class="form-control" value="{{ old('trabajo') }}" required pattern="[A-Za-z]{4,200}" title="SÓLO SE ADMITEN LETRAS. Tamaño mínimo: 4, Tamaño máximo: 20" name="trabajo" ></textarea>
                        </div> 
                      </div>                        
